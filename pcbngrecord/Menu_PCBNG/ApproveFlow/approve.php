...
$sqlid = "SELECT MUSR_ID AS id , MUSR_NAME FROM [AOTHQCDB].[dbo].[MUSR_TBL] WHERE MUSR_STATUS = 1";
...
<body>
    <div class="content-container">
        ...
        <div class="container d-xl-flex flex-column justify-content-center">
            <div class="row">
                <div class="col-4 mt-3">
                    <form action="">
                        ...
                        <div class="row mt-3 ">
                            ...
                            <div class="col-md-12">
                                <label for="" class="flowtxth">ลำดับที่ 1 (รหัสพนักงานที่ดำเนินการ)</label>
                        ...
                        <tbody class="tbody">
                            ...
                            <tr>
                                ...
                                <?php
                                    ...
                                    $shw = $conn->FetchData();
                                    ?>
                                <td><?php echo $shw[0]['APPRD_EMPID']; ?></td>
                                <td><?php echo $shw[1]['APPRD_EMPID']; ?></td>
                                <td><?php echo $shw[2]['APPRD_EMPID']; ?></td>
                                <td><?php echo $shw[3]['APPRD_EMPID']; ?></td>
                            </tr>
                            <?php
                            }
                            ?>

        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-2 ">
                    ...
                    <div class="vr" style="color: #F80054; padding: 1px;"></div>
                    <li class="nav-item">
                        <a class="nav-link" href="" id="data" data-bs-toggle="modal" data-bs-target="#btndata" onclick="setbtndata()"><i class="bi bi-3-square-fill fs-5"></i><span class="ms-2">รายงานโดยแผนก</span> </a>
                    </li>
                    <div class="vr" style="color: #F80054; padding: 1px;"></div>
                    <li class="nav-item">
                        <a class="nav-link" href="" id="report" data-bs-toggle="modal" data-bs-target="#btnreport">
                            <i class="bi bi-4-square-fill fs-5"></i><span class="ms-2">รายงานโดยสายการผลิต</span> </a>
                    </li>
                    <div class="vr" style="color: #F80054; padding: 1px;"></div>
                    <li class="nav-item">

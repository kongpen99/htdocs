        ...
        <div class="px-5">
            <table class="table" id="PCB">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <button type="button" class="btn btn-warning w-50 " id="click" data-bs-toggle="modal"
                                data-bs-target="#click-check"
                                onclick="getData('<?php echo $stmt[$i]['HREC_ID']; ?>', '<?php echo $app2[0]['HAPPR_SEQ']; ?>', '<?php echo $stmt[$i]['HREC_REJECT_STD']; ?>')">
                                Check
                            </button>
                        </td>
            ...
            <div class="modal fade bd-example-modal-xl" data-bs-focus="false" id="click-check" tabindex="-1"
                aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-xl ">
                    <div class="modal-content">
                        <div class="modal-header ">
                            <h1 class="modal-title fs-4" id="exampleModalLabel" style="color: #FF6C22;">ตรวจสอบข้อมูล
                            </h1>
                        ...
                        <form action="">
                            <div class="modal-body overflow-auto ">
                                ...
                                <table class="table" id="data1">
                                    <tr>
                                        <th scope="col"
                                            style="background-color: #d1495b; font-size: 20px; color: #fff; text-align: start; width: 10%;">
                                            Date</th>
                                        <td colspan="2" id="hrec_date" class="border "></td>
                                    </tr>
                                    <tr>
                                        <th scope="col"
                                            style="background-color: #d1495b; font-size: 20px; color: #fff; text-align: start; width: 10%;">
                                            Line</th>
                                        <td colspan="2" id="hrec_line" class="border "></td>
                                    </tr>
                                    <tr>
                                        <th scope="col"
                                            style="background-color: #d1495b; font-size: 20px; color: #fff; text-align: start; width: 10%;">
                                    ...
                                    <tr>
                                        <th scope="col"
                                            style="background-color: #d1495b; font-size: 20px; color: #fff; text-align: start;">
                                            Model Code</th>
                                        <td colspan="2" id="hrec_mdlcd" class="border"></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <th scope="col"
                                            style="background-color: #d1495b; font-size: 20px; color: #fff; text-align: start;">
                                            Serial Number</th>
                                        <td colspan="2" id="hrec_serial" class="border"></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <th scope="col"
                                            style="background-color: #d1495b; font-size: 20px; color: #fff; text-align: start;">
                                            NG Case</th>
                                        <td colspan="2" id="hrec_ngcase" class="border"></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <th scope="col"
                                            style="background-color: #d1495b; font-size: 20px; color: #fff; text-align: start;">
                                            NG Process</th>
                                        <td colspan="2" id="hrec_ngprocess" class="border"></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <th scope="col"
                                            style="background-color: #d1495b; font-size: 20px; color: #fff; text-align: start;">
                                            Problem</th>
                                        <td colspan="2" id="problem" class="border"></td>
                                    </tr>
                                    <tr>
                                        <th scope="col"
                                            style="background-color: #d1495b; font-size: 20px; color: #fff; text-align: start;">
                                            Cause</th>
                                        <td colspan="2" id="cause" class="border"></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <th scope="col"
                                            style="background-color: #d1495b; font-size: 20px; color: #fff; text-align: start;">
                                            Action</th>
                                        <td colspan="2" id="action" class="border"></td>
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col"
                                            style="background-color: #d1495b; font-size: 20px; color: #fff; text-align: start;">
                                            เหตุผลที่ reject</th>
                                        <td colspan="2" id="text_rj" class="border"></td>
                                ...
                                <div class="row">
                                    <div class="d-flex justify-content-between">
                                        <div class="col">
                                            <div class="">
                                                <button type="submit" class="btn btn-warning " id="updaterj"
                                                    name="updaterj"><i class="fa-solid fa-pen-clip mx-2"></i>Update
                                                    ข้อมูลใหม่</button>

                                            </div>
                                            <input type="hidden" name="rejectstd" id="rejectstd">
                                            <div class="">
                                                <button type="submit" class="btn btn-secondary mt-2 " id="deletedata"
                                                    name="deletedata"><i class="fa-solid fa-trash mx-2"></i>Delete
                                                    Data</button>
                                            ...
                                            <div class="d-flex flex-row-reverse ">
                                                <button type="button" class="btn btn-secondary "
                                                    data-bs-dismiss="modal"><i
                                                        class="fa-solid fa-xmark mx-2"></i>Close</button>
                                                <button type="submit" class="btn btn-danger mx-2" id="reject"
                                                    name="reject"><i
                                                        class="fa-solid fa-eject mx-2 "></i>ส่งกลับ</button>
                                                <button type="submit" class="btn btn-warning mx-2" id="edit"
                                                    name="edit"><i
                                                        class="fa-solid fa-pen-to-square mx-2"></i>แก้ไข</button>
                                                <button type="submit" class="btn btn-success " id="submitapp"
                                                    name="submitapp"><i
                                                        class="fa-solid fa-circle-check mx-2 "></i>อนุมัติ</button>

    ...
    <!-- //* row แสดงผลเมนู -->
    <div class="row p-5" id="row-menu">
        <div class="col d-flex justify-content-center">
            <div class="card w-100">
                <div class="card-header d-flex justify-content-center">กรุณาเลือกเมนูที่ต้องการทำงาน</div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-6">
                            <div class="d-flex justify-content-center">
                                <img src="art_checksheet-01.svg" class="w-50 h-100 rounded" alt="..." id="pic-report">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="d-flex justify-content-center">
                                <img src="art_checksheet-02.svg" class="w-50 h-100 rounded" alt="..." id="pic-check">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <table class="table table-hover" id="tb-document">
              <thead id="thead-document" >
                <tr>
                  ...
                  <th style="width:45%; text-align:left;">ชื่อเอกสาร</th>
                  <th style="width:20%; text-align:left;">หมายเลขลงทะเบียน</th>
                  <th style="width:10%; text-align:center;">เลือก</th>
                </tr>
              </thead>
              <tbody id="tbody-document"></tbody>
            </table>
            <a href="#" id="btn-row-menu-back" class="btn btn-secondary">back</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <?php include '01_view/01_check/report.php';?>
